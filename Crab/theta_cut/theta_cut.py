...
histHadron = plt.hist(hadron.theta_deg**2, range=[0,3], bins=20, histtype='step', label='hadronen')
histGammas = plt.hist(gamma.theta_deg**2, range=[0,3], bins=20, histtype='step', label='gammas')
#plt.yscale('log')
plt.legend()
